...
# library(cranlogs)
# cran_R_downloads <- cran_downloads('R', from = '2012-10-01', to = '2017-09-30')
# write_rds(cran_R_downloads, 'cran_R_downloads.rds', compress = 'gz')
...
library(cranlogs)
library(readr)
crandl <- cran_downloads(from = '2012-10-01', to = '2017-09-30')
...
## Difference for each random model
